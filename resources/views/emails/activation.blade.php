                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px; background-color:#ffffff; border-radius:12px; box-shadow:0 2px 8px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td align="center" style="padding:20px; background:#4F46E5; color:#ffffff; border-radius:12px 12px 0 0;">
                            <h1 style="margin:0; font-size:24px;">🎉 Chúc mừng bạn đã đăng ký thành công gói {{$package_name}} trên {{$app_name ?? 'App 3 Gốc'}}!</h1>
                        </td>
                    </tr>
                    <!-- Nội dung -->
                    <tr>
                        <td style="padding:30px;">
                            ...
                            <p style="font-size:16px; color:#555; line-height:1.6;">
                                Cảm ơn bạn đã tin tưởng và đồng hành cùng {{$app_name ?? 'App 3 Gốc'}}.<br>Dưới đây là mã kích hoạt tài khoản của bạn:
                            </p>
                            <!-- Mã kích hoạt -->
                            @if(isset($code))

...
const handleOk = () => {
  ...
  if (isYouTubeVideo.value) {
    ...
    videoPreview.value = youtubeEmbedUrl.value;
...
const handleClose = () => {
  ...
  const saveVideo = form.video_title_show;
  videoPreview.value = ''; // Xóa src để reset video
  setTimeout(() => {
    videoPreview.value = saveVideo;
  }, 300);
};
const goBack = () => {
...
<template>
  ...
  <SchoolLayout :breadcrumbs=breadcrumbs>
            ...
            <div class="content-page w-full sm:px-6 lg:px-8">
              ...
              >
                ...
                <div class="custom-gap mt-8 w-4/5">
                  ...
                  <div class="mb-8 mt-4 justify-center text-center">
    ...
    <a-modal v-model:open="openPreview" @ok="handleOkPreview" :width="1000">
      ...
      >
        <img
          class="relative h-[300px] w-[300px] object-fill"
          :src="form.image_question_show"
          alt=""
        />
    ...
    <a-modal v-model:open="openVideo" :width="800" @cancel="handleClose">
      <div class="flex justify-center">
        <div v-if="form.video_title_show">
          ...
          <div v-else>
            <!-- Nếu không phải YouTube, hiển thị video bình thường -->
            <video :src="videoPreview" controls width="600" height="300" />
          </div>
        </div>

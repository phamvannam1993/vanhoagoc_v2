...
const createListAnswer = (items, infoTemplate, oldListAnswer = [], forceUseTemplate = false) => {
    ...
    return Array.from({ length }, (_, index) => ({
        ...
        type_answer: oldListAnswer[index]?.type_answer,
        inputNumber: oldListAnswer[index]?.inputNumber
    }));
};
                                        ...
                                        <div>
                                            ...
                                            >
                                                ...
                                                <div class="flex justify-between items-center text-xs mt-[2px]">
                                                  ...
                                                  <span v-else></span>
                                                  <span :class="form.content && form.content.length > getQuestionMaxLength() ? 'text-red-500 font-medium' : 'text-gray-400'">{{ form.content ? form.content.length : 0 }}/{{ getQuestionMaxLength() }}</span>
                                                </div>
                                            </Field>
                                            <!--                      <ErrorMessage-->

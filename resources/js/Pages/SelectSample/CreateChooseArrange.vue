...
import PreviewChooseArrangeOne from "@/Pages/SelectSample/Partials/ChooseArrange/PreviewChooseArrangeOne.vue";
...
const optionsInput = ref([
    {
        ...
        totalInput: 2,
        componentMap: PreviewChooseArrangeOne
    }
]);
...
const form = useInertiaForm({
    ...
    pcnl: "",
    ndgd: "",
    content: "Hãy tin những gì khoa học nói.",
    listAnswer: reactive(
...
const handleSubmit = () => {
    ...
    console.log(form.file_reading_name, form.file_background_name, form.image_db)
                            ...
                            >
                                                ...
                                                <a-popover v-model:open="popoverVisible" v-else trigger="click">
                                                    <template #content>
                                                        ...
                                                        <div
                                                            ...
                                                            class="cursor-pointer border border-transparent p-2 transition duration-300 hover:rounded-xl hover:bg-[#d9d9d9]"
                                                        >
                                                              <span @click="textToSpeech(item)">{{ item.name }}</span
                                                              >
                                                        </div>
                                                    </template>
                                                    <img
                                        ...
                                        <div>
                                            ...
                                            >
                                                ...
                                                <div class="flex justify-between items-center text-xs mt-[2px]">
                                                  <span v-if="form.content && form.content.length > getQuestionMaxLength()" class="text-red-500 font-medium">Vượt ký tự, chọn Âm thanh</span>
                                                  <span v-else></span>
                                                  <span :class="form.content && form.content.length > getQuestionMaxLength() ? 'text-red-500 font-medium' : 'text-gray-400'">{{ form.content.length }}/{{ getQuestionMaxLength() }}</span>
                                                </div>
                                            </Field>
                                            <!--                      <ErrorMessage-->
                                ...
                                <div class="mt-2 w-11/12 gap-4">
                                    <div class="w-full font-bold">
                                        Các đáp án. <span class="italic text-semibold text-[#2C75E3]">(Hãy đảo thứ tự đáp án và điền số 1 vào ô trống cho đáp án số 1, số 2 cho đáp án số 2... Đáp án nhiễu (sai) để trống)</span>
                                    </div>
                                    <div
                                        class="mr-4 grid w-full grid-cols-2 gap-4 md:grid-cols-6 lg:grid-cols-7"
                                    >
                                        <div
                                        ...
                                        >
                                            ...
                                            <a-textarea
                                                ...
                                                :rows="2"
                                                class="mb-[0.4rem] mt-[0.125rem] w-full"
                                            >
                                            </a-textarea>
                                            <div class="flex justify-between items-center text-xs mt-[2px]">

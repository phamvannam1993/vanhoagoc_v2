...
const createListAnswer = (items, infoTemplate, oldListAnswer = [], forceUseTemplate = false) => {
  ...
  return Array.from({ length }, (_, index) => ({
    ...
    type_answer: oldListAnswer[index]?.type_answer || 1,
          ...
          <div class="flex w-full">
            <div class="content-page w-full sm:px-6 lg:px-8">
              ...
              >
                ...
                <div class="custom-gap mt-8 grid w-full grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-5">
                  <div
                        ...
                        <div class="mt-2 flex items-center gap-4">
                          <div class="w-5/6 justify-items-center text-center">
                            <div class="flex items-center gap-4">
                              ...
                              <a-popover :open="openPopoverIndex === index" @open-change="(visible) => handlePopoverChange(visible, index)" v-else trigger="click">
                                <template #content>
                                  <div
                ...
                <!--                                />-->
                  <div class="mb-4 mt-2 flex justify-end gap-8">
                      <div class="italic flex text-semibold text-[#2C75E3] items-center">(Bạn hãy nhập nội dung theo thứ tự đúng, không cần đảo vị trí)</div>

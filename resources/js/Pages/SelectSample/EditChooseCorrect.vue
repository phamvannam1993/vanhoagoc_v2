...
const previewComponents = {
  PreviewChooseCorrectOne,
  PreviewChooseCorrectTwo,
  PreviewChooseCorrectThree,
  PreviewChooseCorrectFour,
  PreviewChooseCorrectFive,
  PreviewChooseCorrectSix,
  PreviewChooseCorrectSeven,
  PreviewChooseCorrectEight,
  PreviewChooseCorrectNine,
  PreviewChooseCorrectTen,
  PreviewChooseCorrectEleven,
  PreviewChooseCorrectTwelve,
};
...
const form = useForm({
  id: props.data.id,
  title: props.data.title ?? 'Chọn đáp án đúng',
  ...
  question: props.data.question_val ?? '',
  question_type: props.data.question_type,
  image_question_show:
    props.data.question_type === 2 ? props.data.question_val_show : '',
  image_question_db:
    props.data.question_type === 2 ? props.data.question_val : '',
  audio_question_show:
    props.data.question_type === 3 ? props.data.audio_ques_val : '',
  audio_question_db:
    props.data.question_type === 3 ? props.data.audio_ques_val : '',
                  ...
                  >
                    ...
                    >
                      ...
                      <a-textarea
                        ...
                        :rows="2"
                        :class="`w-full mt-[0.125rem] ${item.type_answer === 1 ? 'mb-[0.4rem]' : ''}`"
                      >
                      </a-textarea>
                    ...
                    <!--                    <InputError-->
                    <!--                      class="mt-2"-->
                    <!--                      :message="form.errors.listAnswer"-->
                    <!--                    />-->
                  </div>
                </div>
                <div

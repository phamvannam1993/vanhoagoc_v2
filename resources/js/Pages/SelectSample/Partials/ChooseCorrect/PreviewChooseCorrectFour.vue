...
<template>
    <a-modal v-model:open="open" @ok="handleOk" :width="1000">
        ...
        <div class="mt-4 flex gap-4">
            <div class="grid w-full gap-4 grid-cols-2 md:grid-cols-2 lg:grid-cols-2 p-4">
                <div
                    v-for="(item, index) in data.listAnswer"
                    :key="index"
                    class="flex min-h-[128px] w-full items-center justify-center rounded-md border-2 border-solid border-[#E5E5E5] bg-white p-6"
                >

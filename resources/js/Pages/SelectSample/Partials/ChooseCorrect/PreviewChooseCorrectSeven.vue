    ...
    <a-modal v-model:open="open" @ok="handleOk" :width="1000">
        ...
        <div class="mt-4 grid gap-y-4">
            <div
                ...
                :key="index"
                class="min-h-[54px] w-full items-center justify-center rounded-md border-2 border-solid border-[#E5E5E5] bg-white max-md:max-w-full"
            >
                ...
                <div v-else class="justify-items-center my-2">
                    <img

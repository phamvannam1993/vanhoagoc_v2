...
<template>
    <a-modal v-model:open="open" @ok="handleOk" :width="1500">
        ...
        <div class="mt-16 flex justify-center gap-4">
            <div
                ...
                :key="index"
                class="min-h-[240px] w-1/6  flex-shrink-0 items-center justify-center rounded-md border-2 border-solid border-[#E5E5E5] bg-white p-4 text-[64px] max-md:max-w-full"
            >

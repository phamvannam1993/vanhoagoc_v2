...
<!--            <img class="w-1/3" v-if="data.image_question_show" :src="data.image_question_show" alt="">-->
            <div
                class="min-h-[120px] w-full rounded-2xl border-2 border-solid border-[#E5E5E5] bg-white p-4 text-[16px] max-md:max-w-full"
            >
        ...
        <div class="m-auto mt-10 flex flex-wrap gap-4">
            <div
                class="rounded-2xl border-2 border-solid border-[#E5E5E5] bg-white w-fit p-4 text-[16px] max-md:max-w-full"

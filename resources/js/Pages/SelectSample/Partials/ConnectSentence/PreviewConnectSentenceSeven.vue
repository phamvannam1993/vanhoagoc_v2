...
<template>
    <a-modal v-model:open="open" @ok="handleOk" :width="1000">
        ...
        <div class="m-auto mt-4 flex w-4/5 gap-16">
            <div class="grid w-1/3 items-center gap-y-16">
                <div
                    v-for="(item, index) in data.listAnswer"
                    :key="index"
                    class="h-max rounded-md border-2 border-solid border-[#E5E5E5] bg-white p-4 max-md:max-w-full"
                >

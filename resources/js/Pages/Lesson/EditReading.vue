...
const form = useForm({
  content: props.reading,
  image_show: props.image_show,
  image_db: props.image_db,
  pdf_show: props.pdf_show,
  pdf_db: props.pdf_db
});
  ...
  axios
    ...
    .then((response) => {
      if (response.data.status) {
        toast.success('Chỉnh sửa bài đọc thành công');
        setTimeout(function () {
...
const handleRemoveOld = (image) => {
  removeImages.value.push(image);
};
</script>
  ...
  <SchoolLayout>
    ...
    <div class="app-page py-4">
      <div class="content-page mx-auto w-4/5 sm:px-6 lg:px-8">
        <h1 class="text-[30px] font-bold text-[#2C75E3]">Sửa bài đọc</h1>
        ...
        <div class="mt-4">
          <Form @submit="handleSubmit">
            ...
            />
              ...
              <div v-if="activeType === 'image'" class="flex justify-center items-center h-[70vh] rounded-2xl border border-solid border-blue-400 bg-white">
...
<!--              <div v-if="type_text !== 1" @click="triggerFileInput" class="flex gap-4 mt-4">-->
<!--                <span>Tải lên</span>-->
<!--                <img-->

...
const backgroundRaw  = props.lesson?.background
    ? props.lesson.background
    : {
        style: 'default',
        value_show: '',
        value_db: '',
...
const colorNotPracticeRaw  = props.lesson?.color_not_practice
    ? props.lesson.color_not_practice
    : {
        style: 'default',
        value_show: '',
        value_db: '',
...
const colorDonePracticeRaw  = props.lesson?.color_done_practice
    ? props.lesson.color_done_practice
    : {
        style: 'default',
        value_show: '',
        value_db: '',
...
const rules = {
  ...
  numberPractice: yup.number().required('ID bài học không được để trống'),
};
const handleSubmit = () => {
    const formData = new FormData();
    formData.append('name', form.name);
    formData.append('numberPractice', parseInt(form.numberPractice));
    formData.append('taptrung', form.taptrung);
    formData.append('week_id', props.lesson.week_id);
    formData.append('book_id', props.lesson.book_id);
  ...
  axios
    .post(route('lessons.json.update'), formData)
    .then((response) => {
...
const handleColorNotChange = () => {
    form.color_not_practice.value_show = '';
    form.color_not_practice.value_db = '';
    form.color_not_practice.value_name = '';
}
const handleColorDoneChange = () => {
    form.color_done_practice.value_show = '';
    form.color_done_practice.value_db = '';
    form.color_done_practice.value_name = '';
}
  ...
  <MasterLayout>
    ...
    <div class="app-page py-4">
      <div class="content-page mx-auto w-full md:w-10/12 sm:px-6 lg:px-8">
        <h1 class="text-[30px] font-bold text-[#2C75E3]">Sửa bài học</h1>
            ...
            <div class="flex gap-8 w-full">
                <div class="w-1/2">
                    ...
                    <div class="relative mt-6 w-full">
                        ...
                        <div
                            v-if="props.lesson.img_show && !form.image_show"
                            class="image-container mt-2 w-4/5"
                        >
                            <img
                                :src="props.lesson.img_show"
                ...
                <div class="w-1/2">
                    ...
                    <div class="relative mt-6 w-full">
                        ...
                        <div class="mt-2 w-4/5 border border-[#5FB2FF] rounded-xl p-4">
                            <div class="flex justify-between items-start w-full">
                                <div class="flex flex-col gap-2">
                                    <a-radio-group v-model:value="form.color_not_practice.style"  @change="handleColorNotChange" class="flex flex-col gap-2">
                                        <a-radio :value="'default'">Mặc định</a-radio>

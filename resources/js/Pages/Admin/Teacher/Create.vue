    ...
    axios
        ...
        .then((response) => {
            if (response.data.status) {
                toast.success('Tạo tài khoản Quản lý/Giáo viên thành công');
                setTimeout(function () {
    ...
    <SchoolLayout>
        ...
        <div class="app-page mx-auto flex w-4/5 gap-4 py-4">
            <div class="content-page w-full">
                <h1 class="text-[30px] font-bold text-[#2C75E3]">Thêm Quản lý/Giáo viên</h1>

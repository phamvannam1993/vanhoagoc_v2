...
const columns = [
    ...
    { title: 'Tên nội dung giáo dục', dataIndex: 'name', key: 'name' },
...
async function loadData() {
    loading.value = true;
    const res = await axios.get(route('admins.educational-contents.json.list', {
...
async function deleteItem(id) {
    ...
    const res = await axios.delete(route('admins.educational-contents.json.delete', id));
    if (res.data.status) {
        ...
        <div class="app-page py-4">
            <div class="content-page mx-auto w-full md:w-10/12">
                ...
                <div class="filter-page mt-4 flex gap-3 items-center">
                    ...
                    <Link :href="route('admins.educational-contents.create')">
                    ...
                    >
                        <template #bodyCell="{ column, record, index }">
                            ...
                            <template v-if="column.key === 'edit'">
                                <Link :href="route('admins.educational-contents.edit', { id: record.id })">

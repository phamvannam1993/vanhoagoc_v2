...
const columns = [
    ...
    { title: 'Tên thành phần năng lực', dataIndex: 'name', key: 'name' },
...
async function deleteItem(id) {
    ...
    const res = await axios.delete(route('admins.competency-components.json.delete', id));
    if (res.data.status) {
        ...
        <div class="app-page py-4">
            <div class="content-page mx-auto w-full md:w-10/12">
                <div class="flex items-center gap-3 mb-2">
                    ...
                    <span>›</span>
                    <span class="font-semibold">{{ competency.name }}</span>
                </div>
                <h1 class="text-[28px] font-bold text-[#2C75E3]">Thành phần Năng lực</h1>
                <div class="filter-page mt-4 flex gap-3 items-center">
                    ...
                    <Link :href="route('admins.competency-components.create', { competency_id: competency.id })">
                    ...
                    >
                        <template #bodyCell="{ column, record, index }">
                            ...
                            <template v-if="column.key === 'edit'">
                                <Link :href="route('admins.competency-components.edit', { id: record.id })">

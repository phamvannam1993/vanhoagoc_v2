...
const form = ref({ id: item.id, competency_id: item.competency_id, name: item.name, code: item.code ?? '' });
const errors = ref({});
    ...
    <MasterLayout>
        <div class="app-page py-4">
            <div class="content-page mx-auto w-full md:w-6/12">
                ...
                <h1 class="text-[28px] font-bold text-[#2C75E3]">Sửa Thành phần Năng lực</h1>

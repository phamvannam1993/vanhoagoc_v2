    ...
    axios
        ...
        .then((response) => {
            if (response.data.status) {
                toast.success("Tạo Đơn vị/Trường học thành công");
                setTimeout(function() {
...
<template>
    ...
    <SchoolLayout>
        <template #header>
            <h2 class="text-xl font-semibold leading-tight text-gray-800">Create Class</h2>
        </template>

        <div class="app-page py-4">
            <div class="content-page mx-auto w-4/5 sm:px-6 lg:px-8">
                <h1 class="text-[30px] font-bold text-[#2C75E3]">Thêm Phòng ban/Lớp</h1>
